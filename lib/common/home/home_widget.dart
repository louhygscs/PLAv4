                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          StreamBuilder<List<SportcategoryRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return FlutterFlowChoiceChips(
                                options: choiceChipsSportcategoryRecordList
                                    .map((e) => e.sportname)
                                    .toList()
                          ...
                          StreamBuilder<List<GamematchRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<GamematchRecord>
                                  listViewGamematchRecordList = snapshot.data!;

                              return ListView.builder(
                                padding: EdgeInsets.zero,
                                shrinkWrap: true,
                                scrollDirection: Axis.vertical,
                                itemCount: listViewGamematchRecordList.length,
                                          ...
                                          children: [
                                            ...
                                            ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(8.0),
                                              child: Image.network(
                                                listViewGamematchRecord.gameImg,
                                                width: 342.0,
                                                height: 133.0,
                                                fit: BoxFit.cover,
                                              ),
