                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          // GetUserSportProfile
                          _model.checkUserSportProfile =
                              await queryUserquestionRecordOnce(
                            queryBuilder: (userquestionRecord) =>
                                userquestionRecord.where(
                              'uid',
                              isEqualTo: currentUserUid,
                            ),
                            singleRecord: true,
                          ).then((s) => s.firstOrNull);
                          if ((_model.checkUserSportProfile != null) == true) {
