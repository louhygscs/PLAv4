...
class _GameMapWidgetState extends State<GameMapWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<GamematchRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final gameMapGamematchRecord = snapshot.data!;
                      ...
                      children: [
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                gameMapGamematchRecord.gameImg,
                                width: 206.0,
                                height: 162.0,
                                fit: BoxFit.cover,
                              ),
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              gameMapGamematchRecord.description,
